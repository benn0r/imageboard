...
--
-- Host: localhost
-- Generation Time: Jan 10, 2012 at 09:40 
...
--
-- Table structure for table `board_search`
--
...
CREATE TABLE IF NOT EXISTS `board_users` (
  ...
  `activity_text` varchar(255) CHARACTER SET latin1 NOT NULL,
  ...
  `header` varchar(4) CHARACTER SET latin1 NOT NULL,
  ...
  `homepage` varchar(255) CHARACTER SET latin1 NOT NULL,
  `hobbies` text CHARACTER SET latin1 NOT NULL,
  `sex` tinyint(1) NOT NULL,
  `notification_own` tinyint(1) NOT NULL,
  `notification_own_mail` tinyint(1) NOT NULL,
  `notification_other` tinyint(1) NOT NULL,
  `notification_other_mail` tinyint(1) NOT NULL,
  `notification_wall` tinyint(1) NOT NULL,
  `notification_wall_mail` tinyint(1) NOT NULL,
  PRIMARY KEY (`uid`),
  KEY `sid` (`sid`),
  KEY `username` (`username`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1125 ;
